...
<body>
    <div class="form-container">
        ...
        <h1>Beck's Depression Inventory</h1>
                    ...
                    <input type="radio" name="question1" value="3">I am so sad and unhappy that I can't stand it.
                    <br>
                    ...
                    <input type="radio" name="question2" value="3">I feel the future is hopeless and that things cannot improve.
                    <br>
                    ...
                    <input type="radio" name="question3" value="3">I feel I am a complete failure as a person
                    <br>
                    ...
                    <input type="radio" name="question4" value="3">I am dissatisfied or bored with everything.
                    <br>
                    ...
                    <input type="radio" name="question5" value="3">I feel quite guilty all the time. 
                    <br>
                    ...
                    <input type="radio" name="question6" value="3">I feel I am being punished. 
                    <br>
                    ...
                    <input type="radio" name="question7" value="3">I hate myself
                    <br>
                    ...
                    <input type="radio" name="question8" value="3">I blame myself for everything bad that happens.
                    <br>
                    ...
                    <input type="radio" name="question9" value="3">I would kill myself if I had the chance
                    <br>
                    ...
                    <input type="radio" name="question10" value="3">I used to be able to cry, but now I can't cry even though I want to
                    <br>
                    ...
                    <input type="radio" name="question11" value="3">I am irritated all the time now.
                    <br>
                    ...
                    <input type="radio" name="question12" value="3">I have lost all of my interest in other people.
                    <br>
                    ...
                    <input type="radio" name="question13" value="3">I can't make decisions at all anymore.
                    <br>
                    ...
                    <input type="radio" name="question14" value="3">I used to be able to cry, but now I can't cry even though I want to
                    <br>
                    ...
                    <input type="radio" name="question15" value="3">I used to be able to cry, but now I can't cry even though I want to
                    <br>
                    ...
                    <input type="radio" name="question16" value="3">I used to be able to cry, but now I can't cry even though I want to
                    <br>
                    ...
                    <input type="radio" name="question17" value="3">I used to be able to cry, but now I can't cry even though I want to
                    <br>
                    ...
                    <input type="radio" name="question18" value="3">I used to be able to cry, but now I can't cry even though I want to
                    <br>
                    ...
                    <input type="radio" name="question19" value="3">I used to be able to cry, but now I can't cry even though I want to
                    <br>
                    ...
                    <input type="radio" name="question20" value="3">I used to be able to cry, but now I can't cry even though I want to
                    <br>
